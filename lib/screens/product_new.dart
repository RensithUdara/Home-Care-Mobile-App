...
class _ProductPageState extends State<ProductPage>
  ...
  Widget build(BuildContext context) {
    ...
    final imgPath = ProductUtils.getImagePath(type);
    ...
    final primaryColor = ProductUtils.getColor(type);
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildDetailRow('Model', widget.product.model, isDark),
                  _buildDetailRow('Brand', widget.product.brand, isDark),
                  if (widget.product.description.isNotEmpty)
                    _buildDetailRow('Description', widget.product.description, isDark),
                ],
              ),
            ),
          ),
